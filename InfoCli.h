	...
	public:
		InfoCli(void)
		{
			...
			try {
				...
				TxConsultaCli::Resultat res = conC.obteResultat();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->modificaButton->Font = (gcnew System::Drawing::Font(L"Gill Sans Ultra Bold", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->modificaButton->Location = System::Drawing::Point(911, 525);
			...
			this->mostrarCentresButton->Location = System::Drawing::Point(698, 525);
			...
			this->mostrarCentresButton->Text = L"Mostrar Mascotes";

...
namespace PetSalut {
	...
	private: System::Windows::Forms::Button^ Apuntat;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Apuntat = (gcnew System::Windows::Forms::Button());
			...
			this->ConsultarMascotesButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->ConsultaVisitesButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->ProgramarVisitesButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->PublicarEventButton->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			...
			this->panel2->Controls->Add(this->Apuntat);
			...
			this->participantsLabel->Location = System::Drawing::Point(362, 407);
			this->participantsLabel->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->participantsLabel->Name = L"participantsLabel";
			this->participantsLabel->Size = System::Drawing::Size(380, 26);
			...
			this->label8->Location = System::Drawing::Point(199, 407);
			...
			this->paginasLabel->Location = System::Drawing::Point(771, 454);
			...
			// Apuntat
			// 
			this->Apuntat->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(224)), static_cast<System::Int32>(static_cast<System::Byte>(224)),
				static_cast<System::Int32>(static_cast<System::Byte>(224)));
			this->Apuntat->Cursor = System::Windows::Forms::Cursors::Hand;
			this->Apuntat->Font = (gcnew System::Drawing::Font(L"Gill Sans Ultra Bold", 10));
			this->Apuntat->Location = System::Drawing::Point(344, 452);
			this->Apuntat->Margin = System::Windows::Forms::Padding(2);
			this->Apuntat->Name = L"Apuntat";
			this->Apuntat->Size = System::Drawing::Size(202, 61);
			this->Apuntat->TabIndex = 35;
			this->Apuntat->Text = L"Apuntat";
			this->Apuntat->UseVisualStyleBackColor = false;
			// 
			// MenuProp
			// 
			...
			this->ClientSize = System::Drawing::Size(1155, 661);
